...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Outbreak serveur.')
    ...
    parser.add_argument('--trace', '-t', help='name of the trace file', default='trace_%s' % (time.strftime("%d-%m-%H-%M-%S")))
